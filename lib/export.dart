...
export 'package:flutter_new_template/core/extensions/string_extension.dart';
export 'package:flutter_new_template/core/extensions/num_extension.dart';
export 'package:flutter_new_template/core/extensions/context_extension.dart';
export 'package:flutter_new_template/core/extensions/widget_extension.dart';

// most used packages
export 'package:flutter_new_template/core/app_router.dart';
...
export 'package:flutter_new_template/i18n/strings.g.dart';
// routes
export 'core/injection_container.dart';
export 'package:flutter_bloc/flutter_bloc.dart';
export 'package:flutter_new_template/core/base_state.dart';
